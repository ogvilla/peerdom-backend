...
import {createRoleHoldingMutation, deleteRoleHoldingMutation, updateRoleHoldingMutation} from './mutations/holders';
...
export const resolvers = {
  ...
  Mutation: {
    ...
    ...deleteNodeMutation,
    ...updateNodeMutation,
    ...createRoleHoldingMutation,
    ...deleteRoleHoldingMutation,
    ...updateRoleHoldingMutation
  }
};
